...
int32_t main(void)
{
    ...
    {
        .enPinMode    = Pin_Mode_Out,   ///< Set pin mode @ref en_pin_mode_t
        .enLatch      = Disable,        ///< Pin output latch enable
        .enExInt      = Enable,         ///< External int enable
        .enInvert     = Disable,        ///< Pin input/output invert enable
        .enPullUp     = Enable,         ///< Internal pull-up resistor enable
        .enPinDrv     = Pin_Drv_L,      ///< Drive capacity setting @ref en_pin_drv_t
        .enPinOType   = Pin_OType_Cmos, ///< Output mode setting @ref en_pin_o_type_t
        .enPinSubFunc = Disable         ///< Pin sub-function enable
    };

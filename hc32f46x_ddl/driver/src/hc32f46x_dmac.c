...
#define DMA_CHCTL_DEFAULT                   (0x00001000u)
#define DMA_DTCTL_DEFAULT                   (0x00000001u)
#define DMA_DAR_DEFAULT                     (0x00000000u)
#define DMA_SAR_DEFAULT                     (0x00000000u)
#define DMA_RPT_DEFAULT                     (0x00000000u)
#define DMA_LLP_DEFAULT                     (0x00000000u)
#define DMA_SNSEQCTL_DEFAULT                (0x00000000u)
#define DMA_DNSEQCTL_DEFAULT                (0x00000000u)
#define DMA_RCFGCTL_DEFAULT                 (0x00000000u)
...
en_result_t DMA_ChannelCmd(M4_DMA_TypeDef* pstcDmaReg, uint8_t u8Ch, en_functional_state_t enNewState)
{
    ...
    if(DMA_IDLE == DmaChEnState)
    {
        ...
        {
            case Enable:
                pstcDmaReg->CHEN |= (1ul << (u8Ch + DMA_CHEN_CHEN_Pos));
                break;
            case Disable:
                pstcDmaReg->CHEN &= (~(1ul << (u8Ch + DMA_CHEN_CHEN_Pos)));
                break;
                        ...
                        const stc_dma_nseq_cfg_t* pstcSrcNseqCfg)
{
    ...
    MODIFY_DMA_CH_REG(&pstcDmaReg->SNSEQCTL0, u8Ch, DMA_SNSEQCTL_SNSCNT, (uint32_t)pstcSrcNseqCfg->u16Cnt);
